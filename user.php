		...
		<div class="col1">
			<div class="contact">
					...
					<ul class="forms" id="user_level">
						...
						<li class="inputfield">
							<select name="user_level_id" id="user_level_id" class="bar" required>
								<?php echo get_new_optionlist("role","role_id","role_name",0); ?>
							</select>
						</li>
					</ul>
					<?php 
				...
				<form action="lib/user.php" enctype="multipart/form-data" method="post" name="frm_user">
					<ul class="forms">
						<li class="txt">Name</li>
						<li class="inputfield"><input name="user_name" type="text" class="bar" required value=""></li>
					</ul>
					<ul class="forms" id="user_level">
						<li class="txt">User Level</li>
						<li class="inputfield">
					...
					<ul class="forms">
						<li class="txt">Username</li>
						<li class="inputfield"><input name="user_username" type="text" class="bar" required value=""></li>
					</ul>
					<ul class="forms">
						<li class="txt">Password</li>
						<li class="inputfield"><input name="user_password" id="user_password" type="password" class="bar" required value=""></li>
					</ul>
					<ul class="forms">
						<li class="txt">Confirm Password</li>
						<li class="inputfield"><input name="user_confirm_password" id="user_confirm_password" type="password" class="bar" required value=""></li>
					</ul>
					<?php } ?>
					<ul class="forms">
						<li class="txt">Mobile</li>
						<li class="inputfield"><input name="user_mobile" type="text" class="bar" required value=""></li>
					</ul>
					<ul class="forms">
						<li class="txt">Email</li>
						<li class="inputfield"><input name="user_email" type="text" class="bar" required value=""></li>
					</ul>
					<ul class="forms">
						<li class="txt">Date of Birth</li>
						<li class="inputfield"><input name="user_dob" id="user_dob" type="text" class="bar" required value=""/></li>
					</ul>
					<ul class="forms">
						<li class="txt">Address Line 1</li>
						<li class="inputfield"><input name="user_add1" type="text" class="bar" required value=""/></li>
					</ul>
					<ul class="forms">
						<li class="txt">Address Line 2</li>
						<li class="inputfield"><input name="user_add2" type="text" class="bar" required value=""/></li>
					</ul>
					<ul class="forms">
						<li class="txt">City</li>
						<li class="inputfield">
