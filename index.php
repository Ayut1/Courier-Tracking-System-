...
?> 
  ...
  <div id="content_sec">
     <div class="col1">
		<h4 class="heading colr">About Courier Tracking System</h4>
			<div class="news">
            <ul>
				<li>
                	<h6 class="last">Manage Couriers</h6>
				...
				<li class="last">
                	<h6 class="last">Manage Trackings</h6>
				...
				<li class="last">
                    ...
                    <a href="#" class="thumb"><img src="images/home4.jpeg" alt="" style="height:163px; width:266px;"/></a>
                    <p>
