...
function delete_tracking(tracking_id)
{
	...
	<div id="content_sec">
		...
		<div class="contact">
				<h4 class="heading colr">Tracking Reports</h4>
			<form name="frm_tracking" action="#" method="post">
				<div class="static">
					<table style="width:100%">
					  <tbody>
					  <tr>
						<td colspan="7">Search : <input type="text" name="tracking_tracking" class="inputfield" style="height: 23px; width: 229px;">&nbsp;&nbsp;<input type="submit" value="Search" class="simplebtn"></td>
					  </tr>
					...
					?>
					  <tr>
						...
						<td style="text-align:center"><a href="tracking.php?tracking_id=<?php echo $data['tracking_id'] ?>">Edit</a> | <a href="Javascript:delete_tracking(<?=$data['tracking_id']?>)">Delete</a> </td>
					  </tr>
					<?php 
						}  
					}
